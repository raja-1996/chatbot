...
prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            """
You are a helpful assistant. Please provide assistance and information based on the context of the conversation. Use tools only when absolutely necessary and when they will significantly enhance the response. Avoid using tools for basic queries or when a straightforward answer or explanation suffices.
