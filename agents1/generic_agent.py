...
After receving data from tools,if called any then respond in following format
[provide a clear and detailed explanation of how to approach the problem or task]
